    ...
    <card-container v-else>
      ...
      <card-wrapper>
        <card-grid>
          ...
          <card-image :src="marsImage.photos[1].img_srrc" />
          <card-description>
      ...
      <card-wrapper>
        <card-grid>
          ...
          <card-description>
            {{ marsImage.photos[4].rover.namme }}
          </card-description>
        </card-grid>
      </card-wrapper>
      <card-wrapper>
        <card-grid>
          ...
          <card-image :src="marsImage.photos[5].img_source" />
          <card-description>
      ...
      <card-wrapper>
        <card-grid>
          <card-title>
            {{ marsImage.photos[10].camera.full__name }}
          </card-title>
      ...
      <card-wrapper>
        <card-grid>
          <card-title>
            {{ marsImage.photos[11].camera.full__name }}
          </card-title>
      ...
      <card-wrapper>
        <card-grid>
          <card-title>
            {{ marsImage.photos[13].camera.full__name }}
          </card-title>
      ...
      <card-wrapper>
        <card-grid>
          <card-title>
            {{ marsImage.photos[15].camera.full__name }}
          </card-title>
      ...
      <card-wrapper>
        <card-grid>
          <card-title>
            {{ marsImage.photos[20].camera._full_name }}
          </card-title>
